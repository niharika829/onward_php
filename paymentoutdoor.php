...
session_start();
if(isset($_SESSION['outdoorpayment'])){
  $conn =mysqli_connect("localhost","root","","parlourproject");

  if(!$conn){
    die("connection failed<br>".mysqli_connect_error());
  }
      $total=$_SESSION['outdoorvalues'];
      $amount=$_SESSION['outdoorpayment'];
...
zipcode:<input type='text' name='zipcode'><br>
  ...
  date:<input type='date' name='userdate'><br>
      select the artist<br/><select name='artist' size='1'>
       <option value='1'>anjali mehta</option><br/>
       <option value='2'>rahish gupta</option><br/>
       <option value='3'>rudraksh</option><br/>
       <option value='4'>urvi chadda</option><br/>
       <option value='5'>ahana</option><br/>
      ...
      <input type='submit' name='final_out_order' value='done'>
      </form></div></center></body></html>";

if(isset($_POST['final_out_order'])){
  ///////////////////////////////////////////////////////////////
  //////////////////////////////////////////////////////////////
...
$random=rand(1000,9999);
            $sql_query="INSERT INTO orders(userid,email,address,userorder,amount,artist_id,entry_time,entry_date,category,orderid,action,cardholder,cardnumber)
             VALUES('$id','$email','$added_address','$total','$amount','$selected_artist','$added_time','$added_date','outdoor','$random','wait for the response','$cardholder','$cardnumber')";
