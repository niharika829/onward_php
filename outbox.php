...
#cont1 {
  ...
  background: url("images/facial1.jpg");
  ...
  #cont2 {
   ...
   background-size: cover;
    ...
    #cont3 {
      ...
      background: url("images/spa2.jpg");
...
.container:hover .overlay {
  ...
  <img src="images/pict1.jpg" alt="Snow" style="width:100%;height:80%;">
  <div class="bottom-left"><div data-aos="fade-right">
              <h2 class="about">OUTDOOR</h2>
              <p><span><a href="home.php"><b>Home</b></a></span>><span class="small">OUTDOOR</span></p></div>
</div>
      ...
      <div class="container-fluid">
        <div class="row">
          <div class="col-md-4">
            ...
            <div class="col-md-8">
      <input style="width:50%;font-size:30px;" type="submit" class="btn btn-warning" name="booknow_outbox" value="book now">
    </div>
    <div class="col-md-4">
