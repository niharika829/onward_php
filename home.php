  ...
  <body>
    <nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
          <div class="container" style="background-color:black;">
            <a class="navbar-brand" href="home.php"style="color:white;"><img src="images/logo.jpg" width=50% height=350% ></a>
          ...
          <div id="myCarousel" class="carousel slide" data-ride="carousel">
            ...
            <div class="carousel-inner">
              ...
              <div class="item active">
                <img src="images/pict1.jpg" alt="Los Angeles" style="width:100%;height:100%;">
                <div class="carousel-caption">
                  <h3>Get Smart Look</h3>
              ...
              <div class="item">
                <img src="images/pict2.jpg" alt="Chicago" style="width:100%;height:100%;">
                <div class="carousel-caption">
              ...
              <div class="item">
                <img src="images/picture3.jpg" alt="New York" style="width:100%;height:100%;">
                <div class="carousel-caption">
                  <h3> Body Care</h3>
...
<div class="parallax_one"><div class="container">
  ...
  <div class="row">
   <div class="col-md-4">
       ...
       <div style="background:transparent url('images/salon1.jpg') no-repeat center center /cover ">
       ...
       <input style="width:60%;font-size:30px;"class="btn btn-danger" type="submit" name="submit_inbox" value="INDOOR"></div>
           ...
           <input  style="width:60%;font-size:30px;" class="btn btn-danger" type="submit" name="submit_outbox" value="OUTDOOR"></div>
               <br><br>    <br><br>
                 <div data-aos="fade-down-right">
	 ...
	 <div class="col-md-7" ><div data-aos="fade-left"><img src="images/handsome.jpg" style="margin-top:15%;width:100%;height:80%"></div></div>
  </div>
</div></div>
